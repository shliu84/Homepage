...
const translations = {
    jp: {
        ...
        hero_title: "垣根を超え、<br><span class='gradient-text'>未来を繋ぐ。</span>",
        ...
        biz_list_1: "国内外における不動産の売買、仲介、賃貸、管理及び不動産コンサルティング業務",
        biz_list_2: "企業向けの起業と経営のコンサルティング、海外企業の日本市場参入並びに日本企業の海外市場参入のサポート業務",
        biz_list_3: "インターネット、電子出版、映像、印刷物等の各種メディアの広告、企画制作及び各種メディアを活用した教育研修事業並びに通信販売事業",
        biz_list_4: "企業経営と企業及び一般社会人の人材育成のための研修、指導講演会、セミナー及びイベントの開催、教育事業並びに、インストラクターの派遣",
        biz_list_5: "著作権、出版権、翻訳権等の管理、売買及び出版に関する業務",
        biz_list_6: "教育人材派遣に関するマネジメントサービス及び労働者派遣事業に関する業務",
        biz_list_7: "海外国内旅行に係る宿泊施設及び鉄道・航空機・船舶・タクシー等の運送機関の手配業務",
        biz_list_8: "コンピュータによる委託会計計算業務及び委託代行による経理事務の管理業務",
    ...
    cn: {
        ...
        hero_title: "打破隔阂，<br><span class='gradient-text'>连接未来。</span>",
    ...
    en: {
        ...
        nav_contact: "Contact",
        hero_badge: "Global Business Solutions",
        hero_title: "Breaking Barriers,<br><span class='gradient-text'>Connecting the Future.</span>",
